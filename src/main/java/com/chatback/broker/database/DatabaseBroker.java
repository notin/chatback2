...
//
//            String sql = "select conversation from message where id = "+id;
//
...
//    }
//
//    public void setMessage(String gui1, String gui2, Message message)
//    {
//        Message m = null;
//        // This SQL statement produces all table
//        // names and column names in the H2 schema
//        String id = " select count(*) from message;";
//        int index = getID(id);
//
//        String sql = "INSERT INTO message VALUES ('"+index+"','"+gui1+"','"+gui2+"', '"+message.getText()+"')";
//
//        ResultSet resultSet = getResult(sql);
//    }
//
